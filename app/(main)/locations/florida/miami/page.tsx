...
import cityData from "@/city-pages/miami-fl.json";
        ...
        <div className="container">
          ...
          <section className="local-proof-section">
            ...
            <div className="map-container">
              <iframe src={cityData.localProof.mapEmbedUrl} width="100%" height="450" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Google Maps - Direct Title Loans Miami Location"></iframe>
            </div>
          </section>
