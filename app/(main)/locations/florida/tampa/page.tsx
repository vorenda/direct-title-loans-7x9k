...
import cityData from "@/city-pages/tampa-fl.json";
...
export default function TampaPage() {
  const breadcrumbs = [
    ...
    { label: "Florida", url: "/locations/florida" },
    { label: "Tampa" }
  ];
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(cityData.schema) }} />
        ...
        <div className="container">
          <header className="hero">
            ...
            <div className="hero-ctas">
              <Link href={cityData.hero.ctaUrl} className="btn btn-accent btn-lg">{cityData.hero.ctaText}</Link>
              <a href={cityData.hero.secondaryCta.url} className="btn btn-outline btn-lg">{cityData.hero.secondaryCta.text}</a>
            </div>
          </header>
            ...
            <div className="nap-card">
              ...
              <div className="nap-details">
                <div className="nap-item">
                  ...
                  <a href={cityData.nap.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="nap-link">Get Directions →</a>
                </div>
                <div className="nap-item">
                  <strong>Phone:</strong>
                ...
                <div className="nap-item">
                  ...
                  <ul className="hours-list">
                    {Object.entries(cityData.localProof.hours).map(([day, hours]) => (
          ...
          <section className="local-proof-section">
            ...
            <div className="map-container">
              <iframe src={cityData.localProof.mapEmbedUrl} width="100%" height="450" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Google Maps - Direct Title Loans Tampa Location"></iframe>
            </div>
          </section>
          ...
          <section className="compliance-section">
            ...
            <div className="compliance-details">
              ...
              <ul className="compliance-list">
                {cityData.stateCompliance.keyPoints.map((point, idx) => (<li key={idx}>{point}</li>))}
              </ul>
              <div className="regulatory-info">
                <p><strong>Regulatory Body:</strong> <a href={cityData.stateCompliance.regulatoryUrl} target="_blank" rel="noopener noreferrer">{cityData.stateCompliance.regulatoryBody}</a></p>
                <p><strong>Contact OFR:</strong> {cityData.stateCompliance.contactPhone}</p>
              </div>
          ...
          <section className="cta-section">
            ...
            <div className="cta-buttons">
              <Link href={cityData.ctaSection.primaryCta.url} className="btn btn-accent btn-lg">{cityData.ctaSection.primaryCta.text}</Link>
              <a href={cityData.ctaSection.secondaryCta.url} className="btn btn-outline btn-lg">{cityData.ctaSection.secondaryCta.text}</a>
            </div>
          </section>
        </div>
      </article>
